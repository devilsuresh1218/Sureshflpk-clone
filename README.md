...
[Suresh Kumar](https://github.com/devilsuresh1218) Flipkart Clone is done with top-notch features for the entrepreneur startups like Flipkart.
...
```bash
  git clone (https://github.com/devilsuresh1218/Sureshflpk-clone.git)
```
